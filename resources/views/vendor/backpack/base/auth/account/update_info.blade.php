...
<section class="content-header">
    ...
    <h1>
        {{ trans('backpack::base.my_account') }}Custom
    </h1>
            ...
            <div class="box padding-10">
                ...
                <div class="box-body backpack-profile-form">
                    ...
                    <div class="form-group">
                        ...
                        <label class="required">Mã Giao Vận Gốc</label>
                        <input required class="form-control" type="text" name="transport_code" value="{{ old('transport_code') ? old('transport_code') : $user->transport_code }}">
                    </div>
